...
public static void waitforVisibilityofElements(WebElement element) {
	try {
...
public void dragAndDrop(WebElement source, WebElement target) {
	try {
		waitforVisibilityofElements(source);
		Actions ac = new Actions(driver);
...
public static String jdbcConnection(int key, String dbName, String userName, String password, String query) throws Throwable {
